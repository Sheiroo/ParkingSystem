...
public class AdminFrame extends javax.swing.JFrame {
    ...
    public AdminFrame(Customers[] ticket, ResultSet Resultset_for_customer, Admins[] admin, ResultSet Resultset_for_admin) {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(130, 89, 89));

        jButton2.setBackground(new java.awt.Color(204, 204, 204));
        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton2.setText("View Available Spots");
        ...
        jButton6.setText("View shifts reports");
        ...
        jButton7.setText("View parked cars report");
        ...
        jLabel5.setBackground(new java.awt.Color(130, 89, 89));
        ...
        jLabel14.setText("   Available Spots");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel14, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 347, Short.MAX_VALUE)
        );
        ...
        jLabel6.setText("Enter name of new admin");

        jLabel7.setFont(new java.awt.Font("Segoe UI Historic", 3, 18)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("Enter password of new admin");
        ...
        jButton9.setBackground(new java.awt.Color(130, 89, 89));
        ...
        jLabel10.setText("Enter admin name");

        jTextField6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jTextField6.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        jButton11.setBackground(new java.awt.Color(130, 89, 89));
        ...
        jPanel9.setBackground(new java.awt.Color(130, 89, 89));

        jLabel11.setFont(new java.awt.Font("Segoe UI Historic", 3, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("shifts reports with payment");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(AdminController.LogIn(Resultset_for_admin, jTextField1.getText(), jTextField2.getText())){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jPanel8.setVisible(false);
        jPanel9.setVisible(false);
        jLabel5.setText("<html><pre>" + Parking.print_totalAvailableSpots(ticket) + "</pre></html>");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        AdminController.addAdmin(Resultset_for_admin, admin, new Admins(jTextField3.getText(), jTextField4.getText()));
        
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        firstFrame frame = new firstFrame(admin, ticket, Resultset_for_customer, Resultset_for_admin);
        setVisible(false);
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        AdminController.updateAdminPassword(Resultset_for_admin, admin, new Admins(jTextField1.getText(), jTextField5.getText()));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        jPanel8.setVisible(false);
        jPanel9.setVisible(false);
        AdminController.deleteAdmin(Resultset_for_admin, jTextField6.getText());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        jPanel9.setVisible(false);
        jLabel9.setText("<html><pre>" + AdminController.parkedCars_Report(ticket) + "</pre></html>");
        jLabel13.setText("parked cars report");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        jLabel12.setText(AdminController.Payment_Report(Resultset_for_customer) + "$");
